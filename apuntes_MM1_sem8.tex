...
\title{\textbf{Apuntes de Modelos Matemáticos I}\\[4pt]
       \large Transcripción, notas de clase y complementos con Nagle, Saff \& Snider (7a ed.)}
\author{Transcripción y edición acumulativa}
...
y las notas de clase, complementadas con desarrollos en \LaTeX\ y con material del libro
\emph{Fundamentals of Differential Equations}, 7a ed., Nagle, Saff \& Snider.
Las figuras con nombre \texttt{fig\_XX\_*.png} fueron generadas con Python/Matplotlib;
las figuras con código \texttt{tikzpicture} están generadas directamente en \LaTeX.
\end{tcolorbox}
...
queda así completamente vinculado al problema de eigenvalores de $A$.
