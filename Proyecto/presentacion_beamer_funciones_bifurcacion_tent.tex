...
\begin{frame}{Puntos fijos}
    ...
    \begin{tikzpicture}[scale=0.75]
        ...
        \draw[thick,blue,domain=0:3.4,smooth] plot (\x,{0.8+0.55*\x+0.18*sin(120*\x)});
        \filldraw[red] (1.9,1.9) circle (2pt) node[below right] {$p$};
    \end{tikzpicture}
    \end{center}
\end{frame}
...
% 17
\begin{frame}{Diagrama de bifurcaci\'on log\'istico}
    \begin{itemize}
        \item Eje horizontal: par\'ametro $\mu$.
        \item Eje vertical: valores asint\'oticos de $x_n$.
        \item Lectura:
        \begin{itemize}
            \item una rama: punto fijo atractor;
            \item dos ramas: ciclo de periodo $2$;
            \item muchas ramas: din\'amica compleja o ca\'otica.
        \end{itemize}
    \end{itemize}
\end{frame}
